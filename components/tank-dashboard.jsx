...
export default function TankDashboard() {
  ...
  const status = level !== null ? 'Reading available' : !tank ? 'Awaiting connection' : connected ? 'Sensor unavailable' : 'Device offline';
  ...
  return <main className="shell">
    ...
    <section className="monitor" aria-label="Tank water level">
      ...
      <div className="monitor-footer"><span><Radio size={15}/> Public readings · Updates every 30 seconds</span><span className="height-note">Height, not litres <CircleHelp size={14}/></span></div>
    </section>
